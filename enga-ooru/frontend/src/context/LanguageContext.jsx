...
const translations = {
  en: {
    ...
    categories: { Property: 'Property', Emergency: 'Emergency', Transport: 'Transport', Taxi: 'Taxi', Services: 'Services', Rent: 'Rent', 'Food & Dining': 'Food & Dining', 'Bus Timings': 'Bus Timings' },
    subcategories: { Land: 'Land', Shop: 'Shop', House: 'House', Vehicles: 'Vehicles', Cycle: 'Cycle / மிதிவண்டி', 'Bus Schedule': 'Bus Schedule / பேருந்து அட்டவணை', Ambulance: 'Ambulance', Hospital: 'Hospital', 'Blood Donor': 'Blood Donor', Taxi: 'Taxi', Travels: 'Travels', 'AC Service': 'AC Service', 'Mobile Service': 'Mobile Service', 'TV Repair': 'TV Repair', 'Washing Machine service': 'Washing Machine service', Electrician: 'Electrician', Plumber: 'Plumber', 'Education & Tuition': 'Education & Tuition', 'Daily Labour & Shifting': 'Daily Labour & Shifting', 'Shop Rent': 'Shop Rent', 'House Rent': 'House Rent', 'Things / Equipment Rent': 'Things / Equipment Rent', 'Home Baker': 'Home Baker', 'Hotel & Restaurant': 'Hotel & Restaurant', 'Meat Stall / Fresh Meat': 'Meat Stall / Fresh Meat' },
